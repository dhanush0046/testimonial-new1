...
//   const [apiKeys, setApiKeys] = useState<{ id: string; createdAt: string }[]>([]);
...
//       fetchApiKeys();
//     } else {
//       // Clear the newApiKey when the modal is closed
//       setNewApiKey(null);
//     }
//   }, [isOpen, spaceId]);
...
//       setApiKeys(keys);
//       // If there are no keys, clear the newApiKey
//       if (keys.length === 0) {
//         setNewApiKey(null);
//       }
//     } catch (error) {
...
//           <DialogDescription className='text-sm text-muted-foreground'>Manage your API keys for this space</DialogDescription>
//         </DialogHeader>
